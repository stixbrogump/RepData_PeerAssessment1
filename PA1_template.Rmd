...
Mean steps per day: `r format(iMean, digits=8)`

Median steps per day: `r iMedian`
...
Interval: 0`r iMaxStepsInterval`
...
```
Mean steps per day: `r format(iMeanI, digits=8)`

Median steps per day: `r format(iMedianI, digits=8)`
